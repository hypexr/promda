...
test('reduceGroupAsync transduce with empty data', async () => {
  ...
  const testTransducer = P.transforms.reduceGroupAsync (testValueFn, () => ([]), R.identity, R.identity, [], testCompFn);
...
test('reduceGroupAsync transduce with small data', async () => {
  ...
  const testTransducer = P.transforms.reduceGroupAsync (
    testValueFn,
    () => ({ [key]: [] }),
    R.identity,
    R.identity,
...
test('reduceGroupAsync transduce observes reduced', async () => {
  ...
  const testTransducer = P.pipeTransducer (
    ...
    P.transforms.reduceGroupAsync (testValueFn, () => ([]), R.identity, R.identity, [], testCompFn),
  );
  const result = await P.transduce (
    testTransducer,
    R.flip (R.append),
